...
class ShopTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final ads = ref
        .watch(activeAdsControllerProvider(AdSection.marketplace))
        .ads;
    ...
    switch (state.status) {
      ...
      case ShopStatus.loaded:
        ...
        final gridCells = isSearching
            ? state.items
            : interleaveAds(state.items, ads);
