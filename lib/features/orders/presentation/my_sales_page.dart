  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: switch (state.status) {
        MySalesStatus.loading => const Center(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () =>
                      ref.read(mySalesControllerProvider.notifier).load(),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _SaleTile(
                      ...
                      onShip: order.status == OrderStatus.held
                          ? () async {
                              final ok = await ref
                                  .read(mySalesControllerProvider.notifier)
                                  .ship(order.id);
                              ...
                              if (!ok) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      ref
                                              .read(mySalesControllerProvider)
                                              .errorMessage ??
